 ...
 */
@Entity
@Table(name = "proyectos_activ_org")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ProyectosActivOrg.findAll", query = "SELECT p FROM ProyectosActivOrg p")
    , @NamedQuery(name = "ProyectosActivOrg.findByPkIdActiv", query = "SELECT p FROM ProyectosActivOrg p WHERE p.pkIdActiv = :pkIdActiv")})
public class ProyectosActivOrg implements Serializable {
    ...
    public ProyectosActivOrg() {
    }

    public ProyectosActivOrg(Integer pkIdActiv) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProyectosActivOrg)) {
            return false;
        }
        ProyectosActivOrg other = (ProyectosActivOrg) object;
    ...
    public String toString() {
        return "model.ProyectosActivOrg[ pkIdActiv=" + pkIdActiv + " ]";
    }
